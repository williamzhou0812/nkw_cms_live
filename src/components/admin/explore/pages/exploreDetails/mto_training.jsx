...
const MtoTraining = () => {
  ...
  const [maxWidth, setMaxWidth] = React.useState('sm');
    ...
    const SaveUpdate = (e) => {
        e.preventDefault();
        axios.put(`/api/mtotrainingexpdetail/${_id}`, mtoTraning ).then(res => {
  ...
  const handleFullWidthChange = event => {
    ...
    return ( 
        <Fragment>
            ...
            <ActiveLastBreadcrumbExploreDetail rootPath="Explore" childOne="MTO Training" path=""/>
            </div>
            ...
            <div className={classes.root} >
                <Grid container spacing={0}>
                     <Grid item xs={6}> 
                        ...
                        <div className="section_title" style={{fontSize:"20px", padding: '10px  35px'}}>
                                <p >{mtoTraning.subtitle[0]}</p>
                                <hr />
                        </div>

                        <div className="construction_logo_section"> 
                            <div>
                                <img src={mtoTraning.logo1} alt="" width="100%"/>
                            </div> 
                            
                        </div>
                        <img  src={mtoTraning.cotegory_footer_img} alt="" width="100%" height="100%" style={{paddingTop: "20px"}} />
                                        ...
                                        <Fragment>
                                            ...
                                            <div className='//*headerEdit'>
                                                ...
                                                <div style={{flex: 1,  border: '1px solid rgb(230, 230, 230)', height: "auto"}}>
                                                    <h3>Header Title</h3>
                                                    <input type="text" value={mtoTraning.title} onChange={e => setMtoTraning({...mtoTraning, title: e.target.value})} /> 
                                                </div> 
                                                <div style={{flex: 1,  border: '1px solid rgb(230, 230, 230)', height: "auto"}}>
                                                    <h3>Background Image</h3>
                                                    <input type="text" value={mtoTraning.header_background_img} onChange={e => setMtoTraning({...mtoTraning, header_background_img: e.target.value})} /> 
                                            ...
                                            <div style={{flex: 1,  border: '1px solid rgb(230, 230, 230)', height: "auto"}}>
                                                ...
                                                <Editor
                                                    ...
                                                    onChange={(e) => setMtoTraning({...mtoTraning, context_editor_one : draftToHtml(convertToRaw(editorState_one.getCurrentContent())).toString()})}
                                            ...
                                            <div style={{flex: 1,  border: '1px solid rgb(230, 230, 230)', height: "auto"}}>
                                                    <h3>LOGO </h3>
                                                    <input type="text" value={mtoTraning.logo1} onChange={e => setMtoTraning({...mtoTraning, logo1: e.target.value})} /> 
                                                    <button type="button" onClick={handleClickOpen} >Libary / Browse Libary</button>
                                                    <button type="button" onClick={() => setMtoTraning({...mtoTraning, logo1: ''})}>remove</button>
                                            </div>


                                            <div style={{flex: 1,  border: '1px solid rgb(230, 230, 230)', height: "auto"}}>
                                                        <h3>Footer Image</h3>
                                                        <input type="text" value={mtoTraning.cotegory_footer_img} onChange={e => setMtoTraning({...mtoTraning, cotegory_footer_img: e.target.value})} /> 
                                                        <button type="button" onClick={handleClickOpen} >Libary / Browse Libary</button>
                                                        <button type="button" onClick={() => setMtoTraning({...mtoTraning, cotegory_footer_img:''})}>remove</button>
                                            </div>
