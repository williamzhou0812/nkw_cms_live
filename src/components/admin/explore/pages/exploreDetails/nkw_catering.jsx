//Explore NKW Cartering Detail page 
...
const NkwCateringExploreDetails = () => { 
    ...
    const  [NkwCatering_Exp, setNkwCatering_Exp ] = useState({
        title: '',
        logo1:'',
        logo2: '',
...
const SaveUpdate = (e) => {
    e.preventDefault();
    axios.put(`/api/nkwcateringexpdetail/${_id}`, NkwCatering_Exp ).then(res => {
...
//Handle Toggle button function show/hidden 
    ...
    return (
        <Fragment>
            ...
            <div style={{
                        ...
                        <ActiveLastBreadcrumbExploreDetail rootPath="Explore" childOne="NKW Catering" path="" />
            </div>
                    ...
                    <Grid item xs={6}>
                        <div className="views_container" style={{border: '23px solid black'}}>
                            <div className="bacgroundImage" style={{
                                     backgroundImage: `url('${NkwCatering_Exp.header_background_img}')` 
                                  }} >
                                <div className="header_title">
                                    <h3 style={{textAlign: 'center'}} > 
                                            {NkwCatering_Exp.title} 
                                    </h3>
                            ...
                            <div style={{padding:'10px 30px', textAlign: 'left', color:'#707070', fontSize:"18px"}}>
                                ...
                                <div className="nkw_caterign_camp_catering_snapshort">

                                        <div className="nkw_catering_camp_catering_left">
                                            <div
                                                dangerouslySetInnerHTML={{__html: draftToHtml(convertToRaw(editorState_two.getCurrentContent()))}}

                                            /> 
                                        </div>
                                        <div className="nkw_catering_camp_catering_right">
                                              <img src={NkwCatering_Exp.logo2} alt="NKW Cartring" />
                                        </div>
                                ...
                                <div className="section_title">
                                                <p style={{fontSize:"20px"}}>{NkwCatering_Exp.subtitle[0]}</p>
                                                <hr />
                                </div>

                                <div className="construction_logo_section"> 
                                        <div>
                                            <img src={NkwCatering_Exp.logo1} alt="" width="100%"/>
                                        </div> 
                            ...
                            <img  src={NkwCatering_Exp.cotegory_footer_img} alt="" width="100%" height="100%" style={{paddingTop: "20px"}} />
                                  ...
                                  { editBtn && (
                                            ...
                                            <div style={{flex: 1,  border: '1px solid rgb(230, 230, 230)', height: "auto"}}>
                                                ...
                                                <Editor
                                                    ...
                                                    onChange={(e) => setNkwCatering_Exp({...NkwCatering_Exp, context_editor_one : draftToHtml(convertToRaw(editorState_one.getCurrentContent())).toString()})}
                                            ...
                                            <div style={{display:"flex",  border: '1px solid rgb(230, 230, 230)', }}>
                                                ...
                                                <div style={{flex: 1, border: '1px solid rgb(230, 230, 230)', }}>
                                                    <Editor
                                                        ...
                                                        onChange={(e) => setNkwCatering_Exp({...NkwCatering_Exp, context_editor_two : draftToHtml(convertToRaw(editorState_two.getCurrentContent())).toString()})}

                                                        />
                                                </div>
                                                <div style={{flex: 1}}>
                                                    <h3>Images:</h3>
                                                    <input type="text" value={NkwCatering_Exp.logo2} onChange={e => setNkwCatering_Exp({...NkwCatering_Exp, logo2: e.target.value}) } />
                                                </div>
                                                <div> 
                                                <button type="button" onClick={handleClickOpen}>Libary / Browse Libary</button>
                                                < button type="button" onClick={() => setNkwCatering_Exp({...NkwCatering_Exp, logo2: ''})}>remove</button>
                                               </div>
                                            ...
                                            <div>
                                                <div style={{flex: 1, border: '1px solid rgb(230, 230, 230)', }}>
                                                    <Editor
                                                        ...
                                                        onChange={(e) => setNkwCatering_Exp({...NkwCatering_Exp, context_editor_three : draftToHtml(convertToRaw(editorState_three.getCurrentContent())).toString()})}
                                            ...
                                            <div style={{textAlign: "left"}}>
                                                    LOGO: 
                                                    <input  type="text" value={NkwCatering_Exp.logo1} onChange={e => setNkwCatering_Exp({...NkwCatering_Exp, logo1: e.target.value}) } />
                                                    <button type="button" onClick={handleClickOpen}>Libary / Browse Libary</button>
                                                    < button type="button" onClick={() => setNkwCatering_Exp({...NkwCatering_Exp, logo1: ''})}>remove</button>
                                            ...
                                            <div style={{textAlign: "left"}}>
                                                    Footer Image: 
                                                    <input  type="text" value={NkwCatering_Exp.cotegory_footer_img} 
                                                            onChange={e => setNkwCatering_Exp({...NkwCatering_Exp, cotegory_footer_img: e.target.value})}
                                                    />

                                                    <button type="button" onClick={handleClickOpen}>Libary / Browse Libary</button>
                                                    < button type="button" onClick={() => setNkwCatering_Exp({...NkwCatering_Exp, cotegory_footer_img: ''})}>remove</button>
...
export default NkwCateringExploreDetails;
